...
//	m_ui->gridLayout->addWidget(chartView, 1, 0);//显示在1行，0列
//	m_charts << chartView;
//
//
//
...
//	QString name("Series ");
//	int nameIndex = 0;
//	//m_dataTable是DataTable声明的一个对象
//	//int i(2)//代表的是定义一个变量i=2;;
...
//}
//
//QChart* ThemeWidget::createLineChart() const//创建LineChart()函数
//{
//	//![1]
//	QChart* chart = new QChart();
...
//}
//
//QChart* ThemeWidget::createPieChart() const//创建PieChart()函数
//{
//	QChart* chart = new QChart();
...
//}
//
//QChart* ThemeWidget::createScatterChart() const//创建createScatterChart() 函数
//{
//	// scatter chart
//	QChart* chart = new QChart();
